                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <span class="text-danger invalid role_err"></span>
                            </div>

                            <div class="col-md-4 mt-3 ward_div" style="display: none;">
                                <label class="col-form-label" for="ward_id">Select Ward <span class="text-danger">*</span></label>
                                <select class="form-control ward_id" name="ward_id">
                            ...
                            <div class="col-md-4 mt-3 department_div" style="display: none;">
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <span class="text-danger invalid password_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <span class="text-danger invalid confirm_password_err"></span>
                            </div>
                        </div>
                    ...
                    <div class="card-body py-2">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <select class="form-control role" id="role_id" name="role">
                                    <option value="">--Select Role--</option>
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->id }}">{{ $role->name }}</option>
                                    @endforeach
                            ...
                            <div class="col-md-4 mt-3 ward_div" id="edit_ward_div" style="display: none;">
                                <label class="col-form-label" for="ward_id">Select Ward <span class="text-danger">*</span></label>
                                <select class="form-control ward_id" name="ward_id">
                                    <option value="">--Select Ward--</option>
                                    @foreach ($wards as $ward)
                            ...
                            <div class="col-md-4 mt-3 department_div" id="edit_department_div" style="display: none;">
                                <label class="col-form-label" for="department_id">Select Department <span class="text-danger">*</span></label>
                                <select class="form-control department_id" name="department_id">
                                    <option value="">--Select Department--</option>
                                </select>
...
<script>
    ...
    $(".role").on("change", function(e) {
        ...
        // Hide both ward_div and department_div initially
        $('.ward_div').hide();
        $('.department_div').hide();
